...
const popupEditProfileForm = document.querySelector(`.popup__form-profile`); /*переменная формы попапа редактирования профиля*/
const cardAddButton = document.querySelector(`.profile__add-button`); /*переменная кнопки добавления карты*/
const popupAddCard = document.querySelector (`.popup_type_card`); /*переменная попапа добавления карты*/
const cardNameInput = document.querySelector(`.popup__input_el_image-name`); /*переменная поля ввода названия карточки*/
const cardUrlInput = document.querySelector(`.popup__input_el_image-url`); /*переменная поля ввода ссылки картинки*/
const sectionElements = document.querySelector(`.elements`); /*создали переменную секции в которую будут добавляться карточки*/
const popupAddCardForm = document.querySelector(`.popup__form-card`); /*переменная формы добавления карты*/
...
const popupBigImage = document.querySelector(`.popup_type_image`);/*переменная попапа увеличения*/
...
function createCard(card){
 ...
 function renderCard (item) {
  ...
  popupAddCardForm.addEventListener(`submit`, addCards);
